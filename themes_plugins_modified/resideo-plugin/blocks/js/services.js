(function(wp) {
            ...
            el('div',
                {
                    className: 'row',
                    style: {
                        display: (layout == 1) || (layout == 4) ? 'none' : 'block'
                    },
                },
                el('div',
                    {
    ...
    registerBlockType('resideo-plugin/services', {
        ...
        attributes: {
            data_content: {
                type: 'string',
                default: '%7B%22title%22%3A%22%22%2C%22subtitle%22%3A%22%22%2C%22image%22%3A%22%22%2C%22image_src%22%3A%22%22%2C%22layout%22%3A%221%22%2C%22margin%22%3A%22no%22%2C%22cta_label%22%3A%22%22%2C%22cta_link%22%3A%22%22%2C%22services%22%3A%5B%5D%7D'
            }
        },
        edit: withState({
            isOpen: false, 
