(function(wp) {
                    ...
                    el('legend',
                        ...
                        el('div',
                            ...
                            el('span',
                                ...
                                __('Agent Card CTA Color', 'resideo'),
                            )
                        )
                    ),
                    el(ColorPalette,
        ...
        var featuredAgentsOptions = [
            ...
            el('div', 
                ...
                el('div', 
                    ...
                    el(TextControl, 
                        {
                            label: __('Agent Card CTA Text', 'resideo'),
                            value: card_cta,
                            placeholder: __('Enter agent card CTA text', 'resideo'),
                            onChange: function(value) {
    ...
    registerBlockType('resideo-plugin/featured-agents', {
        title: __('Featured Agents', 'resideo'),
        description: __('Resideo featured agents block.', 'resideo'),
        icon: {
            src: 'businessman',
            foreground: '#007cba',
        },
