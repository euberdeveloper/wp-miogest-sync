(function(wp) {
    ...
    function FeaturedPropertiesControl(props) {
        ...
        if (isSelected) {
            return el('div', 
                ...
                el('h3', 
                    {
                        className: 'featured-properties-placeholder-header'
                    },
                    title
                ),
                el('h4', 
                    {
                        className: 'featured-properties-placeholder-subheader'
                    },
                    subtitle
                ),
                featuredPropertiesOptions
            );
        } else {
            return el('div', 
                {
                ...
                el('div', 
                    {
                        className: 'featured-properties-placeholder-img'
                    }
                )
            );
        }
    ...
    registerBlockType('resideo-plugin/featured-properties', {
        title: __('Featured Properties', 'resideo'),
        description: __('Resideo featured properties block.', 'resideo'),
        icon: {
            src: 'star-filled',
            foreground: '#007cba',
        },
        ...
        edit: withState({})(FeaturedPropertiesControl),
        save: function(props) {
            return null;
        },
    });
