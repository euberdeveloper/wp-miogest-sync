(function(wp) {
    ...
    function RecentPostsControl(props) {
        ...
        if(isSelected) {
            return el('div', 
                ...
                el('h3', 
                    {
                        className: 'recent-posts-placeholder-header'
                    },
                    title
                ),
                el('h4', 
                    {
                        className: 'recent-posts-placeholder-subheader'
                    },
                    subtitle
                ),
                recentPostsOptions
            ...
            return el('div', 
                ...
                el('div', 
                    {
                        className: 'recent-posts-placeholder-img'
                    }
                )
            );
        }
    ...
    registerBlockType('resideo-plugin/recent-posts', {
        title: __('Recent Blog Posts', 'resideo'),
        description: __('Resideo recent blog posts block.', 'resideo'),
        icon: {
            src: 'list-view',
            foreground: '#007cba',
        },
        ...
        edit: withState({})(RecentPostsControl),
        save: function(props) {
            return null;
        },
    });
